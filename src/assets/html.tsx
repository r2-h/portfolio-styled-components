...
const SvgComponent = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      d={
        'm99.49 41.362 1.446-15.49H22.383l4.34 47.49h54.213L78.81 93.617l-17.362 4.68-17.617-5.106-.936-12.085H27.319l2.128 24.681 32 8.936 32.255-8.936 4.34-48.17H41.107L39.49 41.362z'
      }
      fill={'#fff'}
    />
  </svg>
