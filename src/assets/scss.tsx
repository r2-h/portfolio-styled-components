...
const SvgComponent = (props: SVGProps<SVGSVGElement>) => (
  <svg height={90} viewBox={'2 2 28 28'} width={90} xmlns={'http://www.w3.org/2000/svg'} {...props}>
...
export const SCSSIcon = memo(SvgComponent)
